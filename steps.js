...
const StepsScreen = (props) => {
    ...
    useEffect(() => { 
        const loadInitialData = async () => { 
            ...
            try { 
                ...
                // أ. تحميل الهدف من Supabase أو المحلي
                if (user) {
                ...
                // ب. تحميل الخطوات من Supabase أو المحلي
                if (user) {
    ...
    // ... (باقي الـ Effects الخاصة بـ Pedometer زي ما هي عشان التحديث التلقائي شغال)
    ...
    // ... (باقي دوال التحديات والستريك زي ما هي)
    ...
    // ... (باقي الدوال والـ Render زي ما هو)
    
    // ... (من هنا لحد آخر الملف زي ما هو بالظبط، مفيش تغييرات UI مطلوبة)
